	...
	render() {
			...
			<ul className='us'>
				<li>
					...
					<div className='us-info'>
						...
						<a href='https://github.com/databhishek' target='_blank'>GitHub</a>
					</div>
				</li>
				<li>
					<img src={Arav} />
					<div className='us-info'>
						...
						<a href='https://github.com/aravsaraff' target='_blank'>GitHub</a>
					</div>
				</li>
			</ul>
		);	
		return (
			<div className='main-footer'>
				<Popover isOpen={isContactOpen} position={'bottom'} onClickOutside={() => this.contactPopupToggle(false)} content={us}>
					<button 
						className='contact-us' 
						onClick={() => this.contactPopupToggle(!isContactOpen)}
					>
						Contact Us
					</button>
				</Popover>
